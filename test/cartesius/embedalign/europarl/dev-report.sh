...
# RNN S & Z
#gen:128,inf:rnn-s_rnn-z,opt:adam,e:10,anneal,europarl
cat $experiments/$model/$corpus/gen\:128\,inf\:rnn-s_rnn-z\,opt\:adam\,e:10\,anneal\,europarl/*/*/{0,1}/$testset.best.$criterion.results | python3 $script rnn-sz-yes
